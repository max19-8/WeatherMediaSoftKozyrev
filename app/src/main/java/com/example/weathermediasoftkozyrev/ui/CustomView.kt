...
class CustomView @JvmOverloads constructor(
   ...
   private var progressCircleWidth = 20f
    ...
    init {
        ...
        val textSizeHumidity = typedArray.getDimensionPixelSize(R.styleable.CustomView_android_textSize,(32f * resources.displayMetrics.scaledDensity).roundToInt()).toFloat()
